  ...
  const owners = [
    {
      ...
      social: [
        {
          icon: FaLinkedin,
          link: 'https://linkedin.com/in/fadhluibnu',
          label: 'LinkedIn',
        },
        {
          icon: FaGithub,
          link: 'https://github.com/fadhluibnu',
          label: 'GitHub',
        },
        {
          icon: FaInstagram,
          link: 'https://instagram.com/iybnuw',
          label: 'Instagram',
        },
        {
          icon: FaEnvelope,
          link: 'mailto:fadhluibnua@gmail.com',
          label: 'Email',
        },
      ],
    },
    {
      ...
      social: [
        {
          icon: FaLinkedin,
          link: 'https://linkedin.com/in/m-s-izza',
          label: 'LinkedIn',
        },
        {
          icon: FaGithub,
          link: 'https://github.com/msikkc21',
          label: 'GitHub',
        },
        {
          icon: FaInstagram,
          link: 'https://instagram.com/m.s.ikkc21',
          label: 'Instagram',
        },
        {
          icon: FaEnvelope,
          link: 'mailto:izzaaida21@gmail.com',
          label: 'Email',
        },
      ],
    },
    {
      ...
      social: [
        {
          icon: FaLinkedin,
          link: 'https://www.linkedin.com/in/muhammad-zakariyya-946551284/',
          label: 'LinkedIn',
        },
        {
          icon: FaGithub,
          link: 'https://github.com/muhammadzakariyya13',
          label: 'GitHub',
        },
        {
          icon: FaInstagram,
          link: 'https://instagram.com/zkaryya.m',
          label: 'Instagram',
        },
        {
          icon: FaEnvelope,
          link: 'mailto:zakariyyam20@gmail.com',
          label: 'Email',
        },
      ],
    },
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-slate-600 max-w-2xl mx-auto'>
            Kenali pendiri di balik MahaBisa, mahasiswa dengan visi untuk
            membantu sesama mahasiswa menemukan peluang freelance dan
            mengembangkan keterampilan profesional mereka.
          </p>
        </div>{' '}
            ...
            >
              <div className='relative h-80 overflow-hidden'>
                <img
                  ...
                  onError={e => {
                    e.target.src =
                      'https://via.placeholder.com/400x400?text=Foto+Owner';
                  }}
                />
              </div>
              <div className='p-6'>

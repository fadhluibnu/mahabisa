  ...
  return (
    <section className="py-10 sm:py-16 bg-gradient-to-r from-indigo-600 to-violet-600 relative overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.4'%3E%3Cpath d='M50 50c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10c0 5.523-4.477 10-10 10s-10-4.477-10-10 4.477-10 10-10zM10 10c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10c0 5.523-4.477 10-10 10S0 25.523 0 20s4.477-10 10-10zm10 8c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zm40 40c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8z' /%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")" }}></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="text-indigo-100 text-sm sm:text-base md:text-lg mb-6 sm:mb-8">
              Bergabunglah dengan ribuan mahasiswa yang telah mengembangkan keterampilan dan menghasilkan pendapatan melalui MahaBisa.
            </p>

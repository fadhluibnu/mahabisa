  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border border-slate-100 hover:border-violet-100">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {/* Badge */}
        {service.badge && (
          <span className={`absolute top-3 left-3 py-1 px-3 rounded-full text-xs font-medium text-white ${
      ...
      <div className="p-5">
        ...
        <div className="flex items-center mb-3">
          ...
          />
          <div>
            <div className="text-sm font-medium text-slate-800">{service.creator.name}</div>
            <div className="text-xs text-slate-500">Level {service.creator.level} Seller</div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="ml-1 text-sm font-medium text-slate-800">{service.rating}</span>
            <span className="ml-1 text-xs text-slate-500">({service.reviewCount})</span>
          </div>

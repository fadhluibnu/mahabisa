...
const ServicesGrid = ({ filters, searchValue, activeCategory }) => {
  ...
  const servicesData = [
    {
      ...
      image: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
      badge: "best_seller",
      creator: {
        name: "Anisa W.",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1471107340929-a87cd0f5b5f3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1473&q=80",
      badge: "new",
      creator: {
        name: "Citra P.",
  ...
  const filteredServices = servicesData.filter(service => {
    ...
    if (filters.budget) {
      ...
      if (filters.budget === 'medium' && (service.price < 100000 || service.price > 300000)) return false;
      if (filters.budget === 'high' && (service.price < 300000 || service.price > 500000)) return false;
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {currentServices.length === 0 && (
          <div className="text-center py-12">
            <h3 className="text-lg font-medium text-slate-800 mb-2">Tidak ada jasa yang ditemukan</h3>

...
const TalentDetail = () => {
  const { auth, freelancer, reviewStats, canMessage } = usePage().props;

  // Use the real backend data if available, otherwise fallback to dummy data for demonstration
  const freelancerData = freelancer || {
    ...
    description:
      'Mahasiswa Ilmu Komputer dengan pengalaman 3 tahun di pengembangan web. Spesialis dalam membuat aplikasi web yang modern, responsif, dan user-friendly dengan teknologi React dan Node.js.',
    education: [
      {
        university: 'Universitas Indonesia',
    ...
    experience: [
      {
        ...
        description:
          'Mengembangkan aplikasi web untuk berbagai klien menggunakan React, Node.js, dan MongoDB.',
      },
      {
        ...
        description:
          'Membantu pengembangan UI/UX untuk aplikasi fintech dengan React dan TailwindCSS.',
      },
    ],
    portfolio: [
      {
        ...
        image:
          'https://placehold.co/600x400/e2e8f0/64748b?text=E-Commerce+Dashboard',
        description:
          'Dashboard admin untuk platform e-commerce dengan fitur analitik penjualan dan manajemen produk.',
      ...
      },
      {
        ...
        image:
          'https://placehold.co/600x400/e2e8f0/64748b?text=Project+Management+App',
        description:
          'Aplikasi untuk melacak dan mengelola proyek dengan fitur kanban board dan laporan progres.',
      ...
      },
      {
        ...
        image:
          'https://placehold.co/600x400/e2e8f0/64748b?text=Online+Learning+Platform',
        description:
          'Website pembelajaran online dengan fitur kursus, video, dan forum diskusi.',
    ...
    services: [
      {
        ...
        description:
          'Pembuatan website dari awal hingga akhir dengan teknologi modern seperti React, Node.js, dan MongoDB.',
      },
      {
        id: 2,
        ...
        description:
          'Pembuatan tampilan website yang responsif dan menarik dengan React dan TailwindCSS.',
      },
      {
        id: 3,
        ...
        description:
          'Pembuatan REST API dengan Node.js dan Express untuk mendukung aplikasi frontend.',
      },
    ],
  };
              ...
              <div className='text-center md:text-left flex-1'>
                <div className='flex flex-col md:flex-row md:items-center md:justify-between'>
                  <div>
                    ...
                    <p className='text-xl text-violet-600 font-medium mb-2'>
                      {freelancerData.title}
                    </p>
                    <p className='text-slate-600 mb-3'>
                      {freelancerData.university}
                    </p>
                  </div>
                  ...
                  <div className='flex flex-col sm:flex-row gap-3 mb-4 md:mb-0 items-center justify-center md:justify-end'>
                    {canMessage && (
                      <Link
                        href={`/client/messages?with=${freelancerData.id}`}
                    ...
                    {!auth.user && (
                      <Link
                        href={`/auth?form=login&redirect=/talenta/${freelancerData.id}`}
                        className='py-2.5 px-5 bg-gradient-to-r from-violet-600 to-violet-800 text-white text-center rounded-lg font-medium hover:shadow-md transition-all w-full sm:w-auto'
                      >
                        Login untuk Chat
                      </Link>
                ...
                <div className='flex flex-wrap gap-2 mb-4 justify-center md:justify-start'>
                  {freelancerData.skills && freelancerData.skills.length > 0 ? (
                    ...
                    <span className="text-slate-500">Belum ada keahlian</span>
                  )}
                </div>
                ...
                <div className='flex flex-col sm:flex-row sm:items-center gap-4 justify-center md:justify-start'>
                  <div className='flex items-center gap-1'>
                    ...
                    <span className='text-slate-500'>
                      ({freelancerData.projectCount} proyek)
                    </span>
                  </div>

                  <div
                    className={`flex items-center gap-1 ${freelancerData.isOnline ? 'text-green-500' : 'text-slate-400'}`}
                  >
                    <span
                      className={`w-2.5 h-2.5 rounded-full ${freelancerData.isOnline ? 'bg-green-500' : 'bg-slate-400'}`}
                    ></span>
          ...
          <div className='flex flex-col lg:flex-row gap-8'>
            ...
            <div className='w-full lg:w-2/3'>
                  ...
                  {freelancerData.education && freelancerData.education.length > 0 ? (
                    freelancerData.education.map((edu, index) => (
                      <div
                        key={index}
                        className={
                          index < freelancerData.education.length - 1
                  ...
                  {freelancerData.experience && freelancerData.experience.length > 0 ? (
                    freelancerData.experience.map((exp, index) => (
                      <div
                        key={index}
                        className={
                          index < freelancerData.experience.length - 1
                            ? 'mb-6 pb-6 border-b border-slate-100'
                            : ''
                        }
                      >
                    ...
                    <p className="text-slate-500">Belum ada data pengalaman</p>
                  )}
                </div>
              </div>
              ...
              <div className='bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden'>
                ...
                <div className='p-6'>
                  {freelancerData.testimonials && freelancerData.testimonials.length > 0 ? (
            ...
            <div className='w-full lg:w-1/3'>
              ...
              <div className='bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden mb-8'>
                ...
                <div className='p-6'>
                  {freelancerData.services && freelancerData.services.length > 0 ? (
                    <div className='space-y-6'>
                    ...
                    <p className="text-slate-500">Belum ada layanan</p>
                  )}
                </div>

  ...
  const featuredTalents = [
    {
      ...
      description: 'Mahasiswa Ilmu Komputer dengan pengalaman 3 tahun di UI/UX design dan web development. Spesialis dalam membuat desain yang user-centered dan implementasi dengan teknologi modern.'
    },
    {
      id: 2,
      name: 'Putri Ariani',
      ...
      description: 'Mahasiswi Desain Komunikasi Visual dengan fokus pada editing video dan motion graphics. Telah mengerjakan berbagai proyek untuk brand nasional dan startup.'
    }
  ];
    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <Link href="/talenta" className="text-violet-600 font-medium flex items-center hover:text-violet-800 transition-all">
            Lihat semua talenta
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {featuredTalents.map((talent) => (
            <div key={talent.id} className="bg-white rounded-xl shadow-md hover:shadow-lg border border-slate-100 overflow-hidden transition-all">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/3 relative">
                  <div className="p-4 md:p-6 h-full flex flex-col justify-center">
                    ...
                    <div className={`flex items-center justify-center md:justify-start mt-3 ${
                      ...
                      <span className="text-xs">{talent.isOnline ? 'Online' : 'Offline'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-2/3 p-4 md:p-6">
                  <div className="mb-3">
                    ...
                    <p className="text-violet-600 font-medium">{talent.title}</p>
                    <p className="text-sm text-slate-500">{talent.university}</p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4 md:mb-5">
                    <div className="flex items-center gap-4 md:gap-6">
                      <div className="text-center">
                        <p className="text-lg font-bold text-slate-900">{talent.stats.rating}</p>
                        <p className="text-xs text-slate-500">Rating</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-slate-900">{talent.stats.projects}</p>
                        <p className="text-xs text-slate-500">Proyek</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-slate-900">{talent.stats.clients}</p>

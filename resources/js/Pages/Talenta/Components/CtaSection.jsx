        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="max-w-lg mb-8 lg:mb-0 text-center lg:text-left">
            ...
            <p className="text-slate-600 mb-6">
              Gabung sebagai talenta dan dapatkan akses ke berbagai proyek menarik. 
              Kembangkan portofoliomu dan dapatkan penghasilan tambahan.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link 
                href="/tentang-talenta" 
                className="py-3 px-6 border border-violet-600 text-violet-700 rounded-lg font-medium hover:bg-violet-50 transition-all text-center"
              >

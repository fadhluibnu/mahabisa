  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 py-4 border-b border-gray-200">
      ...
      <div className="flex items-center">
        ...
        {/* Desktop search */}
        <div ref={searchRef} className={`relative mr-4 ${showSearch ? 'block w-full sm:w-auto' : 'hidden sm:block'}`}>
              ...
              <div className="max-h-96 overflow-y-auto">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <p className="text-sm text-gray-800">
                        <span className="font-medium">Budi Setiawan</span> mendaftar sebagai freelancer baru
                      </p>
                ...
                <div className="px-4 py-3 hover:bg-gray-50 border-b border-gray-100 cursor-pointer">
                  <div className="flex">
                    ...
                    <div>
                      <p className="text-sm text-gray-800">
                        Pembayaran <span className="font-medium">#INV-230513</span> telah selesai
                      </p>
                ...
                <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer">
                  <div className="flex">
                    ...
                    <div>
                      <p className="text-sm text-gray-800">
                        <span className="font-medium">Proyek #PRJ-8723</span> melewati tenggat waktu
                      </p>

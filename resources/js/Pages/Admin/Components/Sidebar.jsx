...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (isOpen && event.target.closest('aside') === null && event.target.closest('button') === null) {
        closeSidebar();
      }
    };
      ...
      >
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <div className="flex items-center">
                <span className="font-heading font-bold bg-gradient-to-r from-[#7C3AED] to-[#EC4899] text-transparent bg-clip-text text-lg">MahaBisa</span>
            ...
            <ul className="mt-2">
              <li className="px-3">
                <Link
                  href="/admin/users"
                  className={`flex items-center px-3 py-2.5 rounded-lg ${
                    isActive('users') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="px-3">
                <Link
                  href="/admin/orders"
                  className={`flex items-center px-3 py-2.5 rounded-lg ${
                    isActive('orders') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="px-3">
                <Link
                  href="/admin/payments"
                  className={`flex items-center px-3 py-2.5 rounded-lg ${
                    isActive('payments') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className="mt-2">
              <li className="px-3">
                <Link
                  href="/admin/settings"
                  className={`flex items-center px-3 py-2.5 rounded-lg ${
                    isActive('settings') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

          ...
          <div className='py-4'>
            <div className='bg-white shadow overflow-hidden sm:rounded-lg'>
              ...
              {pendingWithdrawals.links &&
                pendingWithdrawals.links.length > 3 && (
                      ...
                      <div>
                        <p className='text-sm text-gray-700'>
                          ...
                          <span className='font-medium'>
                            {pendingWithdrawals.from}
                          </span>{' '}
                          to{' '}
                          <span className='font-medium'>
                            {pendingWithdrawals.to}
                          </span>{' '}
                          of{' '}
                          <span className='font-medium'>
            ...
            <div className='bg-white shadow overflow-hidden sm:rounded-lg mt-8'>
              ...
              {processedWithdrawals.links &&
                processedWithdrawals.links.length > 3 && (
                  <div className='px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6'>
                    <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                      <div>
                        <p className='text-sm text-gray-700'>
                          Showing{' '}
                          <span className='font-medium'>
                            {processedWithdrawals.from}
                          </span>{' '}
                          to{' '}
                          <span className='font-medium'>
                            {processedWithdrawals.to}
                          </span>{' '}
                          of{' '}
                          <span className='font-medium'>
                            {processedWithdrawals.total}
                          </span>{' '}
                          results
                        </p>
                      </div>
                    ...
                    <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full'>
                      ...
                      <div className='mt-4'>
                        <p className='text-sm text-gray-500 mb-4'>
                          ...
                          request. This information will be shared with the
                          user.
                        </p>
                        <div>
                          <label

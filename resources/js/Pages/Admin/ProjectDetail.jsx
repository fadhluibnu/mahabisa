...
const ProjectDetail = () => {
  ...
  const dummyProject = {
    ...
    progress: 65,
    description:
      'Desain dashboard admin untuk aplikasi manajemen inventaris dengan fitur analitik dan laporan yang komprehensif.',
    ...
    activities: [
      ...
      },
      {
        type: 'milestone',
        user: 'Rina Wijaya',
        action: 'menyelesaikan milestone Design Mockup',
        time: '20 Mei 2023',
      },
      {
        type: 'payment',
        user: 'PT Maju Bersama',
        action: 'melakukan pembayaran Tahap 1',
        time: '18 Mei 2023',
      },
    ],
  };
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 pb-6 border-b border-gray-100'>
          ...
          <div>
            ...
            <div className='flex items-center'>
              <div className='w-5 h-5 rounded-full mr-1 overflow-hidden'>
                <img
                  src={projectData.freelancer.avatar}
                  alt='Freelancer'
                  className='w-full h-full object-cover'
                />
              </div>
              <span className='text-sm font-medium'>
                {projectData.freelancer.name}
              </span>
            </div>
          </div>
          <div>
                    ...
                    <div className='flex items-center'>
                      ...
                      <div>
                        <p className='font-medium'>
                          Project_Mockup_V{file}.pdf
                        </p>
                        <p className='text-xs text-gray-500'>
                          Diunggah oleh Rina Wijaya • 15 Mei 2023
                        </p>
                      </div>
                    </div>
                    <div className='flex'>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div className='bg-gray-50 p-3 rounded-lg rounded-tl-none max-w-md'>
                      ...
                      <p className='text-sm text-gray-600'>
                        Halo, saya ingin menanyakan tentang progress wireframe.
                ...
                <div className='mb-6'>
                  <div className='flex items-start justify-end'>
                    <div className='bg-indigo-50 p-3 rounded-lg rounded-tr-none max-w-md'>
                      ...
                      <p className='text-sm text-gray-600'>
                        Wireframe sudah selesai dan saya sudah upload filenya di
                        tab Files. Silahkan dicek ya. Terima kasih!
                      </p>
                    </div>

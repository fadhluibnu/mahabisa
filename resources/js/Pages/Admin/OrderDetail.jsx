...
const OrderDetail = ({ order }) => {
  ...
  const getStatus = status => {
    return (
      statusMap[status] || { name: status, class: 'bg-gray-100 text-gray-800' }
    );
  };
      ...
      <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6'>
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6'>
          ...
          <div className='flex flex-wrap gap-3'>
            <span
              className={`px-3 py-1 rounded-full text-sm font-medium ${getStatus(order.status).class}`}
            >
                ...
                <div className='w-8 h-8 rounded-full mr-2 overflow-hidden bg-gray-200'>
                  <img
                    src={
                      ...
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(order.client.name)}`
                    }
            ...
            <div>
              ...
              <div className='flex items-center'>
                <div className='w-8 h-8 rounded-full mr-2 overflow-hidden bg-gray-200'>
                  <img
                    src={
                      order.freelancer.profile_photo_url ||
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(order.freelancer.name)}`
                    }
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6'>
        <div className='lg:col-span-2'>
          <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-6'>
            ...
            <div className='prose max-w-none'>
              <p>
                {order.requirements ||
                  'Tidak ada spesifikasi pekerjaan yang diberikan.'}
              </p>
            </div>
        ...
        <div>
          <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6'>
            ...
            <form
              action={route('admin.orders.update-status', { id: order.id })}
              method='POST'
            >

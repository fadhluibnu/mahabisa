    ...
    >
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="text-left text-gray-500 text-sm border-b border-gray-200">
                ...
                <th className="pb-3 font-medium hidden lg:table-cell">Tanggal Bergabung</th>
              ...
              <tr className="border-b border-gray-100 text-sm">
                <td className="py-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Dewi Susanti</span>
                  </div>
                </td>
              ...
              <tr className="border-b border-gray-100 text-sm">
                <td className="py-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Rudi Hartono</span>
                  </div>
                </td>
              ...
              <tr className="border-b border-gray-100 text-sm">
                <td className="py-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Nina Maulida</span>
                  </div>
                </td>
              ...
              <tr className="border-b border-gray-100 text-sm">
                <td className="py-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Agus Pratama</span>
                  </div>
                </td>
              ...
              <tr className="text-sm">
                <td className="py-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Siska Wijaya</span>
                  </div>
                </td>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 z-10">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-lg text-gray-900">Tambah Pengguna Baru</h3>
            ...
            <form>
              <div className="mb-4">
                ...
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
              
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-medium mb-2">Email</label>
                <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
              
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-medium mb-2">Jenis Pengguna</label>
              ...
              <div className="mb-4">
                ...
                <input type="password" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
      ...
      {showFilterModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 z-10">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-lg text-gray-900">Filter Pengguna</h3>
            ...
            <form>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-medium mb-2">Tanggal Bergabung</label>

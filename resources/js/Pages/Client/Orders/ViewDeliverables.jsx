...
const ViewDeliverables = ({ order, files }) => {
  ...
  const handleAcceptDelivery = async () => {
    if (
      !confirm(
        'Are you sure you want to accept this delivery? This will mark the order as completed.'
      )
    ) {
      return;
    }
    ...
    try {
      ...
      if (response.data.success) {
        showToast(
          'Delivery accepted successfully! The order is now complete.',
          'success'
        );
  ...
  const handleRevisionRequest = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        showToast(
          response.data.message || 'Failed to request revision',
          'error'
        );
      }
    } catch (error) {
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
              ...
              <div className='flex'>
                ...
                <div className='ml-3'>
                  <p className='text-sm text-yellow-700'>
                    You need to complete payment before you can access the
                    deliverables.
                  </p>
                  <div className='mt-2'>
                    <a
          ...
          {isOrderDelivered && (
            <div className='mt-6 bg-white shadow-md rounded-lg p-6'>
              ...
              <p className='mb-4'>
                The freelancer has marked this order as delivered. Please review
                the deliverables and take one of the following actions:
              </p>

...
const ServiceList = () => {
  ...
  const services = [
    {
      ...
      description:
        'Saya akan mendesain UI/UX untuk aplikasi mobile Anda dengan pendekatan yang berfokus pada pengalaman pengguna. Termasuk wireframe, mockup, dan prototype.',
    ...
    },
    {
      ...
      description:
        'Saya akan membuat website responsif menggunakan React.js dengan desain modern dan performa yang cepat. Termasuk SEO dan integrasi API.',
    ...
    },
    {
      ...
      description:
        'Saya akan menulis artikel SEO-friendly untuk website Anda dengan penelitian kata kunci yang mendalam untuk meningkatkan peringkat di mesin pencari.',
    ...
    },
    {
      ...
      description:
        'Saya akan mendesain logo premium dan profesional untuk brand Anda dengan konsep yang unik dan sesuai dengan identitas perusahaan.',
    ...
    },
    {
      ...
      description:
        'Saya akan mengembangkan aplikasi Android native dengan Kotlin yang cepat, responsif dan sesuai dengan guideline Material Design.',
    ...
    },
    {
      ...
      description:
        'Saya akan membuat strategi pemasaran media sosial yang komprehensif untuk bisnis Anda termasuk konten, jadwal posting, dan analitik.',
    ...
    },
    {
      ...
      description:
        'Saya akan membuat website WordPress dengan toko online WooCommerce yang profesional, responsif, dan mudah dikelola.',
    ...
    },
    {
      ...
      description:
        'Saya akan mendesain UI untuk aplikasi mobile Anda dengan Figma, termasuk style guide, komponen, dan prototype interaktif.',
    ...
    .filter(
      service =>
        ...
        (priceFilter === 'any' ||
          ...
          (priceFilter === '1000to2500' &&
            parseInt(service.price.replace(/\D/g, '')) > 1000000 &&
            parseInt(service.price.replace(/\D/g, '')) <= 2500000) ||
          (priceFilter === 'over2500' &&
            parseInt(service.price.replace(/\D/g, '')) > 2500000))
    )
    .sort((a, b) => {
  ...
  return (
    <ClientLayout
      ...
      subtitle='Jelajahi layanan dari freelancer terbaik'
    >

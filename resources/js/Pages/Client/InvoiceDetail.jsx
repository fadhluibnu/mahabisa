...
const InvoiceDetail = ({ invoiceId }) => {
  ...
  const invoice = {
    ...
    notes:
      'Terima kasih atas kerjasama yang baik. Pembayaran dapat dilakukan melalui transfer bank ke rekening yang tertera.',
  };
        ...
        <div className='bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden'>
          ...
          <div className='p-6 border-b border-gray-200'>
            <div className='flex flex-col md:flex-row justify-between items-start'>
              <div className='mb-6 md:mb-0'>
                ...
                <div className='mt-3'>
                  <span
                    className={`inline-block px-3 py-1 rounded-full text-sm ${getStatusColor(invoice.status)}`}
                  >
          ...
          <div className='p-6 border-b border-gray-200'>
            ...
            <p className='text-gray-600 mb-2'>
              Status:
              <span
                className={`ml-2 inline-block px-2 py-1 rounded-full text-xs ${getStatusColor(invoice.status)}`}
              >
                {invoice.status.charAt(0).toUpperCase() +
                  invoice.status.slice(1)}
              </span>

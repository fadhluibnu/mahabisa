  ...
  const handleSubmit = e => {
    ...
    post(`/client/services/${service.id}/order`, {
      ...
      onError: serverErrors => {
        // 'errors' di sini adalah dari useForm
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='bg-white rounded-lg shadow overflow-hidden'>
            ...
            <form onSubmit={handleSubmit} className='p-6'>
              {' '}
              {/* Hapus encType='multipart/form-data' di sini, Inertia akan menanganinya */}
              <div className='mb-6'>
                <label
                  htmlFor='requirements'
                  className='block text-sm font-medium text-gray-700 mb-2'
                >
                  Persyaratan & Detail Pesanan{' '}
                ...
                <p className='mt-2 text-sm text-gray-500'>
                  Min. 10 karakter. Sertakan semua detail yang relevan untuk
                  memastikan freelancer dapat memahami kebutuhan Anda dengan
                  baik.
                </p>
              </div>
              <div className='mb-6'>
                ...
                <p className='mt-2 text-sm text-gray-500'>
                  Opsional. Jika tidak diisi, tanggal pengiriman akan otomatis
                  ditetapkan sesuai waktu pengerjaan paket.
                </p>
              </div>
              <div className='mb-6'>
                <label className='block text-sm font-medium text-gray-700 mb-2'>
                ...
                <p className='mt-2 text-sm text-gray-500'>
                  Opsional. Ukuran maksimal file: 5MB. Format yang didukung:
                  ...
                  <div className='mt-2'>
                    ...
                    <ul className='mt-1 text-sm text-gray-500 list-disc pl-5'>
                      {data.attachments.map(
                        (
                          file,
                          index // Gunakan data.attachments
                        ) => (
                          <li key={index}>

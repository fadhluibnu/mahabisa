  ...
  const activeProjects =
    propProjects?.map(project => {
      ...
      return {
        ...
        image:
          acceptedProposal?.user?.profile_photo_url ||
  ...
  const recentActivities =
    propActivities?.map(activity => {
      ...
      const activityInfo = activityTypeMap[activity.activity_type] || {
        type: 'other',
        title:
          activity.activity_type?.replace(/_/g, ' ')?.charAt(0).toUpperCase() +
            activity.activity_type?.replace(/_/g, ' ')?.slice(1) || 'Aktivitas',
      };
              ...
              {activeProjects.length > 0 ? (
                ...
                <div className='text-center py-8'>
                  ...
                  <p className='mt-1 text-sm text-gray-500'>
                    Mulai membuat proyek baru untuk menemukan freelancer yang
                    tepat.
                  </p>{' '}
                  <div className='mt-6'>
                    <a

...
const ReviewCreate = ({ projectId, freelancerId }) => {
  ...
  const handleSubmit = e => {
    ...
    if (comment.trim().length < 10) {
      alert(
        'Silakan berikan ulasan yang lebih mendetail (minimal 10 karakter)'
      );
      return;
    }
              ...
              <li>
                <div className='flex items-center'>
                  ...
                  <Link
                    ...
                    className='ml-1 text-gray-500 hover:text-indigo-600 md:ml-2'
                  >
                    {project.title}
                  </Link>
                </div>
          ...
          {isSubmitted ? (
            <div className='text-center py-12'>
              ...
              <p className='text-gray-600 mb-6'>
                Umpan balik Anda sangat berarti bagi kami dan freelancer.
              </p>
              <Link
                href={`/client/projects/${project.id}`}
                ...
                <div className='flex items-center mb-6'>
                  ...
                  <div>
                    <h2 className='text-xl font-bold text-gray-900 mb-1'>
                      Beri Ulasan untuk {project.freelancer.name}
                    </h2>

                ...
                <div className="max-h-60 overflow-y-auto">
                  <div className="px-4 py-3 hover:bg-gray-50 border-b border-gray-100 cursor-pointer">
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-sm text-gray-800">Pesan baru dari <span className="font-medium">Alex Suryanto</span></p>
                  ...
                  <div className="px-4 py-3 hover:bg-gray-50 border-b border-gray-100 cursor-pointer">
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-sm text-gray-800">Pembayaran <span className="font-medium">#INV-230513</span> berhasil</p>

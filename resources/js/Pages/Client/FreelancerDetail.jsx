...
const FreelancerDetail = ({ id, user }) => {
  ...
  const freelancer = {
    ...
    description:
      'Saya adalah full stack developer dengan pengalaman lebih dari 3 tahun dalam pengembangan web dan mobile. Saya ahli dalam React, Laravel, dan Node.js. Saya menawarkan solusi pengembangan yang efisien dan tepat waktu untuk memenuhi kebutuhan Anda.',
    skills: [
      'Web Development',
      'React.js',
      'Laravel',
    ...
    portfolio: [
      {
        ...
        description:
          'Website e-commerce lengkap dengan sistem pembayaran, keranjang belanja, dan panel admin.',
      ...
      },
      {
        ...
        description:
          'Aplikasi web untuk manajemen proyek dan kolaborasi tim dengan fitur real-time notification.',
    ...
    reviews: [
      {
        ...
        date: '23 Mei 2024',
        comment:
          'Sangat profesional dan komunikatif. Ricky menyelesaikan proyek sesuai dengan kebutuhan dan tepat waktu. Saya sangat puas dengan hasilnya.',
      },
      {
        id: 2,
        user: {
        ...
        date: '14 April 2024',
        comment:
          'Bekerja dengan Ricky sangat menyenangkan. Ia memiliki kemampuan teknis yang bagus dan responsif terhadap revisi. Akan menggunakan jasanya lagi di masa depan.',
      },
    ],
  };
  ...
  return (
    <ClientLayout
      ...
      subtitle='Lihat informasi dan portfolio freelancer'
    >
                ...
                <div className='space-y-3'>
                  {freelancer.education.map((edu, index) => (
                    <div key={index} className='flex items-start'>
                      <svg
                        className='w-5 h-5 mr-2 mt-0.5 text-indigo-500'
                        fill='none'
                        stroke='currentColor'
                        viewBox='0 0 24 24'
                      >
              ...
              <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div className='flex items-center'>
                    ...
                    <span className='text-gray-600'>
                      Bergabung sejak: {freelancer.memberSince}
                    </span>
                  </div>
                  <div className='flex items-center'>
                    <svg
                    ...
                    <span className='text-gray-600'>
                      Terakhir aktif: {freelancer.lastActive}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className='flex items-center justify-between mb-6'>
                ...
                <div className='flex items-center'>
                  <div className='flex items-center text-yellow-400 mr-2'>
                    ...
                    <span className='ml-1 text-gray-800 font-semibold text-xl'>
                      {freelancer.rating}
                    </span>
                  </div>
                  <span className='text-gray-600'>
                    dari {freelancer.reviewCount} ulasan
                  </span>
                </div>
              </div>

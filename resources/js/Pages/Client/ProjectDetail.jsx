...
const ProjectDetail = ({ id }) => {
  ...
  const [project, setProject] = useState({
    ...
    tasks: [
      {
        id: 1,
        title: 'Desain Halaman Utama',
        status: 'completed',
        dueDate: '2025-06-05',
      },
      {
        id: 2,
        title: 'Implementasi Keranjang Belanja',
        status: 'in-progress',
        dueDate: '2025-06-10',
      },
      {
    ...
    messages: [
      ...
      },
      {
        ...
        content:
          'Halo, untuk halaman checkout sudah 80% selesai. Saya sudah mengintegrasikan dengan payment gateway dan sedang menyelesaikan tampilan responsifnya.',
      ...
      },
      {
        ...
        sender: 'Alex Suryanto',
        content:
          'Sejauh ini lancar, hanya perlu sedikit penyesuaian untuk tampilan mobile. Saya akan kirimkan updatenya besok.',
                    ...
                    {project.tasks.map(task => (
                      <tr key={task.id}>
                        ...
                        <td className='px-6 py-4 whitespace-nowrap text-sm'>
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusBadge(task.status)}`}
                          >
                  ...
                  <tbody className='bg-white divide-y divide-gray-200'>
                    {project.milestones.map(milestone => (
                      <tr key={milestone.id}>
                        ...
                        <td className='px-6 py-4 whitespace-nowrap text-sm'>
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusBadge(milestone.status)}`}
                          >
            ...
            <div>
              ...
              <div className='bg-white rounded-lg shadow p-6'>
                <div className='flex flex-col sm:flex-row items-center sm:items-start mb-6'>
                  ...
                  <div>
                    <h4 className='text-xl font-medium text-gray-900'>
                      {project.freelancerDetails.name}
                    </h4>
                    <p className='text-gray-500'>
                      {project.freelancerDetails.title}
                    </p>
                    ...
                    <div className='mt-3 flex items-center'>
                      <div className='flex items-center'>
                        ...
                        <span className='ml-2 text-gray-600'>
                          {project.freelancerDetails.rating}
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <dl className='grid grid-cols-1 gap-x-4 gap-y-6'>
                      <div className='sm:col-span-1'>
                        ...
                        <dd className='mt-1 text-sm text-gray-900'>
                          {project.freelancerDetails.completedProjects}
                        </dd>
                      </div>
                      <div className='sm:col-span-1'>
                        <dt className='text-sm font-medium text-gray-500'>
                        ...
                        <dd className='mt-1 text-sm text-gray-900'>
                          {project.freelancerDetails.onTime}
                        </dd>
                      </div>
                      <div className='sm:col-span-1'>
                        <dt className='text-sm font-medium text-gray-500'>
                        ...
                        <dd className='mt-1 text-sm text-gray-900'>
                          {project.freelancerDetails.responseTime}
                        </dd>
                      </div>
                    </dl>
                  </div>
                  ...
                  <div>
                    ...
                    <dl className='grid grid-cols-1 gap-x-4 gap-y-6'>
                      <div className='sm:col-span-1'>
                        ...
                        <dd className='mt-1 text-sm text-gray-900'>
                          {project.freelancerDetails.email}
                        </dd>
                      </div>
                      <div className='sm:col-span-1'>
                        <dt className='text-sm font-medium text-gray-500'>
                        ...
                        <dd className='mt-1 text-sm text-gray-900'>
                          {project.freelancerDetails.phone}
                        </dd>
                      </div>
                    </dl>
                  </div>
                ...
                <div className='mt-6 flex justify-center sm:justify-start space-x-3'>
                  ...
                  <Link
                    href={`/client/reviews/create?projectId=${project.id}&freelancerId=${project.freelancerDetails.id || ''}`}

...
const Messages = ({
  ...
  return (
    <ClientLayout
      title='Pesan'
      subtitle='Kelola semua percakapan Anda dengan freelancer'
    >
          ...
          <div className='w-1/3 border-r border-gray-200 flex flex-col'>
            ...
            <div className='overflow-y-auto flex-1'>
              {filteredConversations.map(conversation => (
                ...
                >
                  <Link
                    href={`/client/messages?with=${conversation.user.id}`}
                    className='block'
                  >
                ...
                <div className='flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50'>
                  {messages.map(message => (
                    ...
                    >
                      ...
                      <div
                        className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${message.is_mine ? 'bg-teal-500 text-white' : 'bg-white border border-gray-200'}`}
                      >
                        <p className='text-sm'>{message.content}</p>
                        <p
                          className={`text-xs mt-1 ${message.is_mine ? 'text-teal-100' : 'text-gray-500'}`}
                        >

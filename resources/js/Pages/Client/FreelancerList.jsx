...
const FreelancerList = () => {
  ...
  const freelancers = [
    ...
    },
    {
      ...
      description:
        'Content writer profesional dengan keahlian SEO. Saya membantu bisnis meningkatkan visibility online melalui konten berkualitas tinggi yang dioptimalkan untuk mesin pencari.',
    ...
    },
    {
      ...
      description:
        'Full stack developer dengan pengalaman lebih dari 7 tahun. Spesialisasi saya adalah pengembangan aplikasi web dan mobile dengan fokus pada performa dan UI yang menarik.',
    ...
    },
    {
      ...
      description:
        'Designer dengan fokus pada branding dan identitas visual. Saya membantu perusahaan membangun brand yang konsisten dan berkesan melalui desain logo dan sistem identitas yang kuat.',
    ...
    },
    {
      ...
      description:
        'WordPress expert dengan pengalaman lebih dari 5 tahun. Saya menawarkan solusi lengkap mulai dari desain hingga pengembangan website yang responsif dan user-friendly.',
    ...
    },
    {
      ...
      description:
        'UI/UX designer dengan fokus pada pengalaman pengguna. Saya menciptakan desain yang tidak hanya menarik secara visual tetapi juga fungsional dan mudah digunakan.',
      location: 'Jakarta, Indonesia',
      isOnline: true,
    ...
    },
    {
      ...
      description:
        'Digital marketer dengan pengalaman mengelola kampanye sukses untuk berbagai industri. Spesialisasi saya adalah social media marketing dan paid advertising.',
      location: 'Bandung, Indonesia',
      isOnline: false,
      completedProjects: 65,
      responseRate: '94%',
    ...
    },
    {
      ...
      description:
        'Mobile developer dengan keahlian dalam pengembangan aplikasi Android dan iOS. Saya membangun aplikasi yang cepat, responsif dan menarik dengan fokus pada pengalaman pengguna.',
      location: 'Surabaya, Indonesia',
      isOnline: true,
  ...
  const currentItems = filteredFreelancers.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  return (
    <ClientLayout
      ...
      subtitle='Temukan freelancer terbaik untuk proyek Anda'
    >
      <div className='bg-white rounded-lg shadow-sm p-6'>
        ...
        <div className='mb-4 text-sm text-gray-500'>
          ...
          {Math.min(indexOfLastItem, filteredFreelancers.length)} dari{' '}
          {filteredFreelancers.length} freelancer
          {categoryFilter !== 'all' &&
            ` dalam kategori ${categories.find(c => c.id === categoryFilter)?.name}`}
        ...
        <div className='space-y-6'>
          {filteredFreelancers.length > 0 ? (
            currentItems.map(freelancer => (
              <div
                key={freelancer.id}
                className='border border-gray-200 rounded-lg overflow-hidden hover:border-indigo-500 transition-colors duration-200'
              >
                <div className='p-6'>
            ...
            <div className='text-center py-12'>
              ...
              <h3 className='mt-2 text-sm font-medium text-gray-900'>
                Tidak ditemukan freelancer
              </h3>
              <p className='mt-1 text-sm text-gray-500'>
                Coba ubah filter pencarian Anda atau gunakan kata kunci yang
                berbeda.
              </p>
            </div>
          )}

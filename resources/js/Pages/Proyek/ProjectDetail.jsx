          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8'>
            ...
            <nav className='text-sm text-slate-500 mb-6'>
              <ol className='list-none p-0 inline-flex'>
                <li className='flex items-center'>
                  <a href='/proyek' className='hover:text-indigo-500'>
                    Proyek
                  </a>
                  <svg
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                        ...
                        <div>
                          ...
                          {project.attachments.length > 0 ? (
                            ...
                            <p className='text-slate-500'>
                              Tidak ada file lampiran untuk proyek ini.
                            </p>
                          )}
                        </div>
                      )}
              ...
              <div className='lg:col-span-1'>
                    ...
                    <div className='flex items-center mb-4'>
                      ...
                      <div>
                        ...
                        <div className='text-sm text-slate-500'>
                          Anggota sejak {project.client.memberSince}
                        </div>
                      </div>
                    </div>
                ...
                {/* Bid Form Card */}
                {project.status === 'open' && <SubmitBid project={project} />}
                    ...
                    <div className='p-6'>
                      <div className='text-center p-4'>
                        ...
                        <h3 className='text-lg font-semibold text-slate-900 mb-2'>
                          Proyek Sudah Tidak Terbuka
                        </h3>
                        <p className='text-slate-600 mb-4'>
                          Proyek ini sedang dalam pengerjaan atau sudah selesai
                          sehingga tidak lagi menerima penawaran baru.
                        </p>
                        <a
                          href='/proyek'

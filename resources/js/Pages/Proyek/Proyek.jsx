          ...
          <section className="py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex border-b-2 border-slate-200 mb-8">
                <button
                  className={`py-4 px-8 font-semibold ${activeTab === 'semua' 
                ...
                <button
                  className={`py-4 px-8 font-semibold ${activeTab === 'terbuka' 
                    ? 'text-indigo-500 border-b-2 border-indigo-500 -mb-0.5' 
                    : 'text-slate-600 hover:text-slate-800'}`}
                ...
                <button
                  className={`py-4 px-8 font-semibold ${activeTab === 'diproses' 
                    ? 'text-indigo-500 border-b-2 border-indigo-500 -mb-0.5' 
                    : 'text-slate-600 hover:text-slate-800'}`}

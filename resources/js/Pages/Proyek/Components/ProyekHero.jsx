...
const ProyekHero = () => {
  return (    <section className="py-16 bg-slate-50 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mt-6">
          Temukan proyek freelance yang sesuai dengan keahlian dan minatmu, atau posting proyek baru untuk menemukan talenta terbaik.
        </p>
      </div>
    </section>
  );

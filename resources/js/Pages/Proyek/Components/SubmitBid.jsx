...
const SubmitBid = ({ project }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
      <div className="p-6">
        <h3 className="text-lg font-semibold text-slate-900 mb-4">Ajukan Penawaran</h3>
        ...
        {showSuccess ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            <div className="flex">
              ...
              <div>
                <h4 className="text-sm font-medium text-green-800">Penawaran Terkirim!</h4>
                <p className="text-sm text-green-700 mt-1">
                  Penawaran Anda telah berhasil terkirim. Kami akan memberi tahu Anda jika klien merespons penawaran Anda.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              {/* Bid Amount */}
              <div>
                <label htmlFor="bidAmount" className="block text-sm font-medium text-slate-700 mb-1">
                  Jumlah Penawaran (Rp)
                </label>
              ...
              {/* Delivery Days */}
              <div>
                <label htmlFor="deliveryDays" className="block text-sm font-medium text-slate-700 mb-1">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Minimal 100 karakter. Jelaskan kualifikasi, pendekatan, dan timeline Anda.
                </p>
              </div>

                  ...
                  <div className='space-y-6'>
                    ...
                    <div>
                      ...
                      <p className='mt-1 text-xs text-gray-500'>
                        Deskripsi singkat tentang Anda yang akan ditampilkan di
                        profil Anda.
                      </p>
                    </div>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden'>
              ...
              <div className='p-4 sm:p-6'>
                <form onSubmit={handlePasswordUpdate}>
                  <div className='space-y-6'>
                    ...
                    <div>
                      ...
                      />
                      <p className='mt-1 text-xs text-gray-500'>
                        Password harus terdiri dari minimal 8 karakter dengan
                ...
                <div className='mt-10 pt-10 border-t border-gray-200'>
                  ...
                  <p className='mt-1 text-sm text-gray-500'>
                    Berikut adalah daftar perangkat yang telah login ke akun
                    Anda.
                  </p>
                  ...
                  <div className='mt-4 space-y-4'>
                    <div className='flex justify-between items-center p-4 bg-gray-50 rounded-lg'>
                      <div>
                        ...
                        <div className='mt-1 text-xs text-gray-500'>
                          Jakarta, Indonesia - 31 Mei 2025, 10:25 WIB
                        </div>
                      </div>
                    ...
                    <div className='flex justify-between items-center p-4 bg-gray-50 rounded-lg'>
                      <div>
                        ...
                        <div className='mt-1 text-xs text-gray-500'>
                          Jakarta, Indonesia - 29 Mei 2025, 15:10 WIB
                        </div>
                      </div>
                      <button
                        type='button'
                  ...
                  <div className='space-y-6'>
                    <div className='flex items-start'>
                      ...
                      <div className='ml-3 text-sm'>
                        ...
                        <p className='text-gray-500'>
                          Aktifkan untuk menerima semua notifikasi melalui
                          email.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='space-y-4 ml-6'>
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          <label
                            ...
                            className={`font-medium ${notificationSettings.emailNotifications ? 'text-gray-700' : 'text-gray-400'}`}
                          >
                            Update Proyek
                          </label>
                          <p
                          ...
                          >
                            Pemberitahuan tentang perubahan status proyek,
                            deadline, dan lainnya.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          ...
                          >
                            Pemberitahuan saat Anda menerima pesan baru dari
                            klien.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          ...
                          >
                            Pemberitahuan saat Anda menerima ulasan baru dari
                            klien.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          ...
                          >
                            Pemberitahuan tentang pembayaran yang diterima atau
                            diproses.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='flex items-start'>
                      ...
                      <div className='ml-3 text-sm'>
                        ...
                        <p className='text-gray-500'>
                          Terima email tentang tips freelancing, penawaran
                          khusus, dan update platform.
                        </p>
                      </div>
                    </div>
                ...
                <form onSubmit={handlePrivacyUpdate}>
                  <div className='space-y-6'>
                    <div>
                      ...
                      >
                        <option value='public'>
                          Publik - Semua orang dapat melihat profil Anda
                        </option>
                        <option value='registered'>
                          Terdaftar - Hanya pengguna terdaftar yang dapat
                          melihat profil Anda
                        </option>
                        <option value='clients'>
                          Klien - Hanya klien yang pernah bekerja dengan Anda
                          yang dapat melihat profil lengkap
                        </option>
                      </select>
                    </div>
                    ...
                    <div className='space-y-4'>
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          <label
                            ...
                            className='font-medium text-gray-700'
                          >
                            Tampilkan Penghasilan
                          </label>
                          <p className='text-gray-500'>
                            Izinkan pengunjung profil melihat estimasi
                            penghasilan Anda.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start'>
                            ...
                            onChange={() =>
                              setPrivacySettings({
                                ...
                                showCompletedProjects:
                                  !privacySettings.showCompletedProjects,
                              })
                            }
                            className='h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded'
                          />
                        ...
                        <div className='ml-3 text-sm'>
                          <label
                            htmlFor='showCompletedProjects'
                            className='font-medium text-gray-700'
                          >
                            Tampilkan Proyek Selesai
                          </label>
                          <p className='text-gray-500'>
                            Izinkan pengunjung profil melihat proyek yang telah
                            Anda selesaikan.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start'>
                        ...
                        <div className='ml-3 text-sm'>
                          ...
                          <p className='text-gray-500'>
                            Izinkan pengunjung profil melihat rating dan ulasan
                            yang Anda terima.
                          </p>
                        </div>
                      </div>

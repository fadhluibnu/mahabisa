...
const MessageDetail = () => {
  ...
  return (
    <FreelancerLayout
      title="Pesan"
      subtitle="Komunikasi dengan klien Anda"
    >
            ...
            <div className="overflow-y-auto max-h-96">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-medium text-gray-900 truncate">Budi Santoso</p>
                      <p className="text-xs text-gray-500">10:40</p>
                    </div>
                    <p className="text-xs text-gray-500 truncate">Redesain Website E-commerce</p>
                    <p className="text-xs text-gray-600 truncate">Siap, akan saya tambahkan filter berdasarkan ukuran...</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-medium text-gray-900 truncate">Diana Putri</p>
                      <p className="text-xs text-gray-500">Kemarin</p>
                    </div>
                    <p className="text-xs text-gray-500 truncate">Pengembangan Aplikasi Mobile</p>
                    <p className="text-xs text-gray-600 truncate">Baik, ditunggu update-nya ya.</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-medium text-gray-900 truncate">Ahmad Rizal</p>
                      <p className="text-xs text-gray-500">08/06</p>
                    </div>
                    <p className="text-xs text-gray-500 truncate">Integrasi Payment Gateway</p>
                    <p className="text-xs text-gray-600 truncate">Terima kasih atas bantuannya.</p>
                  </div>
                </div>
              </Link>
            </div>
          ...
          <div className="bg-white shadow-sm rounded-xl overflow-hidden mb-6 flex flex-col h-[calc(100vh-13rem)]">
            ...
            <div className="p-4 bg-white border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">{conversation.client.name}</p>
                  <p className="text-xs text-gray-500">
                    {conversation.client.online ? 'Online' : `Terakhir dilihat: ${conversation.client.lastSeen}`}
                  </p>
                </div>
              </div>
              <div>
                ...
                >
                  <span className="truncate max-w-[150px]">{conversation.project.title}</span>
                </Link>
              </div>
            </div>
                  ...
                  {messages.map((msg) => (
                    ...
                    >
                      ...
                      >
                          ...
                          <div className="mt-2">
                            {msg.attachment.type === 'image' ? (
                              <a href={msg.attachment.url} target="_blank" rel="noopener noreferrer" className="block">
                                ...
                                />
                                <p className="text-xs mt-1 opacity-75">{msg.attachment.name}</p>
                              </a>
                            ) : (
                              <a
                        ...
                        <span className={`text-xs block mt-1 ${msg.sender === 'freelancer' ? 'text-indigo-100' : 'text-gray-500'}`}>
                          {msg.time}
                        </span>
                      </div>
                    </div>
              ...
              <div className="bg-gray-50 border-t border-gray-200 p-2">
                <div className="flex flex-wrap gap-2">
                  {attachments.map((file, index) => (
                    <div key={index} className="relative bg-white border border-gray-200 rounded-md p-2 w-32">
                      {file.type === 'image' ? (

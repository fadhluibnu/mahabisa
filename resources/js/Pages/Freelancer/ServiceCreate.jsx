...
const ServiceCreate = ({ categories = [], skills = [] }) => {
  ...
  const handleGalleryImageChange = e => {
    ...
    const newGalleryPreviews = newGalleryImages.map(file =>
  ...
  const handleSubmit = e => {
    ...
    const isPackageComplete = formData.packages.some(
      pkg =>
        pkg.name &&
        pkg.price &&
        pkg.deliveryTime &&
        pkg.revisions &&
        pkg.features.some(f => f)
    );
    ...
    formData.packages.forEach((pkg, packageIndex) => {
      ...
      if (pkg.name && pkg.price) {
        ...
        submitData.append(
          `packages[${packageIndex}][delivery_time]`,
          pkg.deliveryTime
        );
        submitData.append(
          `packages[${packageIndex}][revisions]`,
          pkg.revisions
        );
          ...
          <div className='bg-white shadow-sm rounded-xl overflow-hidden mb-6'>
            ...
            <div className='p-6'>
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <p className='mt-1 text-sm text-gray-500'>
                      Buat judul yang menarik dan menjelaskan layanan Anda
                      secara singkat.
                    </p>
                  </div>
                    ...
                    <div className='mt-1'>
                      ...
                      {(!categories || categories.length === 0) && (
                        <p className='mt-1 text-sm text-red-600'>
                          Tidak ada kategori tersedia. Harap hubungi
                          administrator.
                        </p>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-gray-500'>
                      Berikan informasi yang jelas tentang layanan Anda dan
                      keuntungan yang akan diterima klien. Minimal 50 karakter.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-500 mb-2'>
                      Pilih keahlian yang relevan dengan layanan Anda (minimal
                      satu).
                    </p>
                    ...
                    {skills.length === 0 && (
                      <div className='mt-2 text-sm text-yellow-600 bg-yellow-50 p-2 rounded'>
                        Tidak ada keahlian tersedia. Silakan tambahkan keahlian
                        di halaman profil Anda terlebih dahulu.
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-gray-500'>
                      Upload gambar utama yang akan ditampilkan sebagai
                      thumbnail layanan Anda.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    {galleryPreviews.length >= 5 && (
                      <p className='text-sm text-yellow-600'>
                        Maximum 5 gallery images allowed. Remove some images if
                ...
                <div>
                  <div className='mb-6 flex items-center justify-between'>
                    <p className='text-sm text-gray-500'>
                      Buat paket layanan yang akan ditawarkan kepada klien. Anda
                      dapat membuat hingga 3 paket.
                    </p>
              ...
              {activeSection === 'requirements' && (
                <div>
                  <p className='text-sm text-gray-500 mb-6'>
                    Jelaskan persyaratan atau informasi apa yang Anda butuhkan
                    dari klien untuk memulai proyek.
                  </p>
              ...
              {activeSection === 'faqs' && (
                <div>
                  <p className='text-sm text-gray-500 mb-6'>
                    Tambahkan pertanyaan yang sering diajukan oleh klien tentang
                    layanan Anda.
                  </p>

...
const ServiceDetail = ({
  ...
  console.log(
    'Service requirements data type:',
    typeof initialService.requirements
  );
    ...
    faqs: [
      {
        ...
        answer:
          'Tidak, biaya hosting dan domain tidak termasuk dalam paket. Namun, saya dapat membantu Anda dalam proses pemilihan dan setup hosting yang sesuai dengan kebutuhan website Anda.',
      },
      {
        question: 'Apakah website yang dibuat mobile friendly?',
        answer:
          'Ya, semua website yang saya kembangkan bersifat responsive dan dapat diakses dengan baik pada perangkat mobile, tablet, maupun desktop.',
      },
      {
        question: 'Apakah bisa melakukan penambahan fitur di luar paket?',
        answer:
          'Ya, bisa. Penambahan fitur akan dikenakan biaya tambahan sesuai dengan kompleksitas fitur yang diminta.',
      },
      {
        question: 'Apakah ada garansi untuk website yang dibuat?',
        answer:
          'Ya, saya memberikan garansi perbaikan bug selama 1 bulan setelah website selesai dikembangkan.',
      },
    ],
    stats: {
      orders: 27,
  ...
  const [service, setService] = useState(() => {
    ...
    if (initialService) {
      ...
      return {
        ...
        requirements: Array.isArray(initialService.requirements)
  ...
  const handleToggleStatus = () => {
    axios
      .put(`/freelancer/services/${service.id}/toggle-status`)
      .then(response => {
            ...
            <button
              ...
              onClick={() => {
                ...
                if (!service || !service.packages) {
                  console.warn(
                    'Service or packages is undefined - setting defaults'
                  );
            ...
            <button
              ...
              onClick={() => {
                ...
                if (!service || !Array.isArray(service.requirements)) {
                  console.warn(
                    'Requirements is not an array - setting defaults'
                  );
                  setService(prevService => ({
                    ...prevService,
                    requirements: Array.isArray(prevService.requirements)
                      ? prevService.requirements
                      : [],
                  }));
                }
        ...
        {activeTab === 'requirements' && (
          <div className='p-6'>
            ...
            <div className='bg-gray-50 rounded-lg p-4 mb-6'>
              <p className='text-sm text-gray-700 mb-4'>
                Untuk memberikan hasil terbaik, klien perlu menyediakan
                informasi dan bahan berikut:
              </p>
                        ...
                        <div className='flex-shrink-0 mr-4'>
                          <img
                            src={
                              ...
                              `https://ui-avatars.com/api/?name=${encodeURIComponent(review.client?.name || 'User')}`
                            }
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <p className='text-2xl font-bold text-gray-900'>
                  {service.stats?.orders || service.ordersCount || 0}
                </p>
              </div>
              ...
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <p className='text-2xl font-bold text-gray-900'>
                  {service.stats?.inProgress || service.activeOrders || 0}
                </p>
              </div>
              ...
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <p className='text-2xl font-bold text-gray-900'>
                  {service.stats?.completed || service.completedOrders || 0}
                </p>
              </div>
              ...
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <div className='flex items-center'>
                  <p className='text-2xl font-bold text-gray-900 mr-2'>
                    {service.stats?.avgRating || service.rating || 0}
                  </p>
                  <div className='flex'>
                    {renderStars(
                      Math.round(
              ...
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <p className='text-2xl font-bold text-gray-900'>
                  {service.stats?.totalReviews || service.reviewsCount || 0}
                </p>
              </div>
            </div>
                    ...
                    {chartData.labels.map((label, index) => (
                      <div key={index} className='flex flex-col items-center'>
                        <div
                          ...
                          style={{
                            height: `${Math.max(chartData.orders[index] * 10, 10)}px`,
                          }}
                        ></div>
                        <div
                          className='bg-green-500 rounded-b-sm w-8'
                          style={{
                            height: `${Math.max(chartData.completed[index] * 10, 0)}px`,
                          }}
                        ></div>

    ...
    >
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
        <div className="p-4 sm:p-6 border-b border-gray-100 flex justify-between items-center">
          <h3 className="text-lg font-semibold text-gray-900">Daftar Kemampuan</h3>
          <button
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      title={skill.verified ? "Kemampuan terverifikasi tidak dapat dihapus" : "Hapus kemampuan"}
                    >
                      <svg
                        className="h-5 w-5"
                        xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900">Tip Meningkatkan Profil</h3>
        </div>
        <div className="p-4 sm:p-6">
          <div className="space-y-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-gray-900">Tambahkan Kemampuan yang Relevan</h4>
                <p className="mt-1 text-sm text-gray-500">
                  Fokus pada kemampuan yang relevan dengan layanan yang Anda tawarkan untuk meningkatkan peluang mendapatkan proyek.
                </p>
              </div>
            </div>
            <div className="flex">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-gray-900">Jujur Dalam Menilai Kemampuan</h4>
                <p className="mt-1 text-sm text-gray-500">
                  Berikan penilaian yang jujur terhadap tingkat keahlian Anda untuk membangun kepercayaan dengan klien.
                </p>
              </div>
            </div>
            <div className="flex">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-gray-900">Dapatkan Verifikasi Kemampuan</h4>
                <p className="mt-1 text-sm text-gray-500">
                  Kemampuan terverifikasi akan meningkatkan kredibilitas profil Anda. Lengkapi tes keahlian untuk mendapatkan verifikasi.
                </p>
              </div>
            </div>
          </div>

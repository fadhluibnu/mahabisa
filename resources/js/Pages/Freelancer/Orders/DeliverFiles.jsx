        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div className="p-6">
              ...
              <div className="border-b pb-4 mb-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Rp {parseInt(order.amount).toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Delivery Deadline:</p>
                    <p className="font-medium">{order.deadline ? new Date(order.deadline).toLocaleDateString() : 'Not specified'}</p>
                  </div>
                </div>
              </div>
              ...
              {order.description && (
                <div className="mb-4">
                  <h3 className="text-md font-medium mb-2">Order Description</h3>
          ...
          <div className="mb-6">
            <FileUploader orderId={order.id} onUploadComplete={handleFileUploaded} />
          </div>
          ...
          {order.status === 'in_progress' && (
            <div className="mt-6 flex justify-end">
              <button
                type="button"
                onClick={() => {
                  if (confirm('Are you sure you want to mark this order as delivered? This will notify the client that the work is complete.')) {

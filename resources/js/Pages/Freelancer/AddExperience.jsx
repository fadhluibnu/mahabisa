...
const AddExperience = () => {
  ...
  return (
    <FreelancerLayout title="Tambah Pengalaman" subtitle="Tambahkan riwayat pengalaman kerja Anda">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-800">Tambah Pengalaman</h2>
              <Link

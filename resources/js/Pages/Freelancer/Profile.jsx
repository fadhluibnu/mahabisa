...
const Profile = () => {
  ...
  const profile = {
    personal: {
      ...
      imageUrl:
        'https://ui-avatars.com/api/?name=Alex+Suryanto&background=8b5cf6&color=fff&size=200',
      socialMedia: {
    ...
    education: [
      {
        ...
        year: '2014 - 2018',
        description:
          'Lulus dengan IPK 3.8. Fokus pada pengembangan web dan mobile.',
      },
      {
    ...
    experience: [
      {
        ...
        year: '2020 - Sekarang',
        description:
          'Mengembangkan dan memelihara aplikasi web enterprise menggunakan React dan Laravel. Memimpin tim pengembangan frontend yang terdiri dari 5 orang.',
      },
      {
        ...
        year: '2018 - 2020',
        description:
          'Mengembangkan aplikasi web e-commerce dari awal hingga peluncuran. Implementasi fitur pembayaran, manajemen produk, dan analitik.',
      },
      {
        ...
        year: '2017 - 2018',
        description:
          'Magang selama kuliah. Membantu pengembangan website untuk klien dengan fokus pada front-end.',
      },
    ],
    portfolio: [
      {
        ...
        description:
          'Platform e-commerce lengkap dengan manajemen produk, keranjang belanja, pembayaran, dan analitik.',
        technologies: ['React', 'Node.js', 'MongoDB', 'Stripe'],
        image:
          'https://via.placeholder.com/300x200/6366f1/ffffff?text=E-commerce',
      },
      {
        title: 'CRM System',
        description:
          'Sistem manajemen hubungan pelanggan untuk bisnis kecil dan menengah.',
        technologies: ['Laravel', 'Vue.js', 'MySQL', 'AWS'],
        image:
          'https://via.placeholder.com/300x200/8b5cf6/ffffff?text=CRM+System',
      },
      {
        title: 'Learning Management System',
        description:
          'Platform pembelajaran online dengan fitur kursus, video streaming, dan manajemen konten.',
          ...
          <div className='bg-white rounded-xl shadow-sm overflow-hidden'>
            ...
            <div className='px-6 py-4 border-t border-gray-200'>
              <Link
                ...
                className='w-full flex items-center justify-center px-4 py-2 border border-indigo-300 rounded-md shadow-sm text-sm font-medium text-indigo-700 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
              >
                <svg
              ...
              {activeTab === 'experience' && (
                <div>
                  ...
                  <div className='flex justify-between items-center mb-4'>
                    ...
                    <Link
                      href='/freelancer/add-experience'
                      className='px-3 py-1 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                    >
                      Tambah Pengalaman
                    </Link>

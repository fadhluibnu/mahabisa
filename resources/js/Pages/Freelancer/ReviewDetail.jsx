...
const ReviewDetail = ({ id }) => {
  ...
  const review = {
    ...
    rating: 5,
    comment: 'Sangat puas dengan hasil kerjanya. Desain website sangat menarik dan sesuai dengan kebutuhan kami. Komunikasi lancar dan selalu responsif terhadap feedback yang diberikan. Kami sangat merekomendasikan freelancer ini untuk pengembangan website e-commerce. Terima kasih atas kerja kerasnya!',
    date: '15 Jun 2023',
    aspects: [
  ...
  const handleTogglePublic = () => {
    ...
    // Show success message
    alert(review.isPublic ? 'Ulasan disembunyikan dari profil Anda' : 'Ulasan ditampilkan di profil Anda');
  };
      ...
      <div className="bg-white shadow-sm rounded-xl overflow-hidden mb-6">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="mb-4">
              <h4 className="text-base font-medium text-gray-900">{review.project.title}</h4>
              <p className="mt-1 text-sm text-gray-600">{review.project.description}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm font-medium text-gray-500">Tanggal Selesai</p>
                <p className="text-sm text-gray-900">{formatDate(review.project.completedDate)}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Budget Proyek</p>
        ...
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Ulasan Klien</h3>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="mb-4">
              <p className="text-sm text-gray-600 italic">"{review.comment}"</p>
              <p className="mt-2 text-xs text-gray-500">Diterima pada {review.date}</p>
            </div>
            
            <h4 className="text-sm font-medium text-gray-900 mb-2">Penilaian Aspek</h4>
        ...
        {review.reply && (
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Balasan Anda</h3>
            <div className="bg-blue-50 rounded-lg p-4">
              <p className="text-sm text-gray-600">{review.reply.text}</p>
              <p className="mt-2 text-xs text-gray-500">Dibalas pada {review.reply.date}</p>
            </div>
          </div>
        )}
      ...
      <div className="bg-white shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            />
            <div className="ml-4">
              <h4 className="text-lg font-medium text-gray-900">{review.client.name}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">{review.client.totalProjects} proyek</p>
            </div>
          </div>

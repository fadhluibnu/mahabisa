...
const Orders = ({ orders, filters, orderCounts }) => {
  ...
  const handleSearch = e => {
    ...
    window.location.href =
      '/freelancer/orders?status=' + currentTab + '&search=' + searchTerm;
  };
  ...
  const handleTabChange = tab => {
    setCurrentTab(tab);
    window.location.href =
      '/freelancer/orders?status=' + tab + '&search=' + searchTerm;
  };
      ...
      >
        <div className='p-6'>
          ...
          <p className='mb-4 text-red-600'>
            Peringatan: Tindakan ini tidak dapat dibatalkan dan mungkin
        ...
        {orders.data && orders.data.length > 0 ? (
          ...
          <div className='bg-white shadow-md rounded-lg p-8 text-center'>
            ...
            <p className='text-gray-500 max-w-md mx-auto'>
              {currentTab === 'all'
                ? 'Anda belum memiliki pesanan. Pastikan layanan Anda sudah aktif dan terlihat oleh client.'
                : currentTab === 'pending'
                  ? 'Anda tidak memiliki pesanan yang menunggu konfirmasi saat ini.'
                  : currentTab === 'in_progress'
                    ? 'Anda tidak memiliki pesanan yang sedang dikerjakan saat ini.'
                    : currentTab === 'delivered'
                      ? 'Anda tidak memiliki pesanan yang sudah terkirim dan menunggu persetujuan.'
                      : currentTab === 'completed'

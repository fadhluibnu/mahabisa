...
const Earnings = () => {
  ...
  const pendingPayments = [
    ...
    },
    {
      ...
      date: '15 Jul 2023',
      status: 'pending',
      image: 'https://ui-avatars.com/api/?name=PT+Edukasi+Digital&background=3b82f6&color=fff',
    },
  ];
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Total Penghasilan</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Pembayaran Tertunda</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Rata-rata Bulanan</h3>
          <p className="text-2xl font-bold text-gray-800">Rp4.500.000</p>
          <div className="mt-2 flex items-center text-green-600">
            <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z" clipRule="evenodd" />
            </svg>
            <span className="text-sm font-medium">+8.2% dari 6 bulan terakhir</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        <h2 className="text-lg font-bold text-gray-800 mb-4">Penghasilan Bulanan</h2>
        <div className="h-80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-4">Pembayaran Terbaru</h2>
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            {earnings.map((payment, index) => (
              <div key={payment.id} className={`p-4 ${index !== earnings.length - 1 ? 'border-b border-gray-100' : ''}`}>
                <div className="flex items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500 truncate">{payment.client}</p>
                  </div>
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-4">Pembayaran Tertunda</h2>
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            {pendingPayments.map((payment, index) => (
              <div key={payment.id} className={`p-4 ${index !== pendingPayments.length - 1 ? 'border-b border-gray-100' : ''}`}>
                <div className="flex items-center">
                  <img
                    src={payment.image}
                    alt={payment.client}

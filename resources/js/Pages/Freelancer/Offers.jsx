...
const Offers = () => {
  const [offers, setOffers] = useState([
    {
      ...
      deadline: '2025-06-30',
      description:
        'Membutuhkan website e-commerce untuk bisnis pakaian dengan fitur keranjang belanja, pembayaran online, dan manajemen inventaris.',
      status: 'pending',
      date: '2025-05-28',
      isNew: true,
    },
    {
      ...
      deadline: '2025-07-15',
      description:
        'Pengembangan aplikasi mobile untuk layanan pengiriman barang dengan fitur tracking real-time, pembayaran digital, dan notifikasi.',
      status: 'pending',
      date: '2025-05-27',
      isNew: true,
    },
    {
      ...
      deadline: '2025-06-15',
      description:
        'Redesign website perusahaan konstruksi untuk tampilan yang lebih modern, responsive, dan user-friendly.',
      status: 'accepted',
      date: '2025-05-20',
      isNew: false,
    },
    {
      ...
      client: {
        name: 'TechNow',
        avatar:
          'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
      },
      budget: 2000000,
      deadline: '2025-06-05',
      description:
        'Desain logo dan branding lengkap untuk startup teknologi yang berfokus pada solusi IoT.',
      status: 'declined',
      date: '2025-05-15',
      isNew: false,
    },
  ...
  const handleAcceptOffer = offer => {
    ...
    setOffers(
      offers.map(o =>
        o.id === offer.id ? { ...o, status: 'accepted', isNew: false } : o
      )
    );
  ...
  const handleDeclineOffer = offer => {
    ...
    setOffers(
      offers.map(o =>
        o.id === offer.id ? { ...o, status: 'declined', isNew: false } : o
      )
    );
  ...
  const handleSendResponse = action => {
    ...
    setOffers(
      offers.map(o =>
        o.id === selectedOffer.id ? { ...o, status: action, isNew: false } : o
      )
    );

    // In a real app, you would send an API request here
    console.log(
      `Offer ${selectedOffer.id} ${action === 'accepted' ? 'accepted' : 'declined'} with message: ${responseData.message}`
    );
                    ...
                    <div className='mt-4 sm:mt-0 sm:ml-4 flex sm:flex-col sm:space-y-2 space-x-2 sm:space-x-0'>
                      ...
                      <button
                        onClick={e => {
                          ...
                          console.log(
                            'Accept button clicked for offer:',
                            offer.id
                          );
                      ...
                      <button
                        onClick={e => {
                          ...
                          e.preventDefault(); // Prevent default behavior
                          console.log(
                            'Decline button clicked for offer:',
                            offer.id
                          );
                    ...
                    <div className='mt-4'>
                      ...
                      <div className='mb-4'>
                        ...
                        <input
                          ...
                          className='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
                          disabled={responseData.message.includes(

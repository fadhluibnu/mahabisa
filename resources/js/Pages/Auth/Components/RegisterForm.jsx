    ...
    <form onSubmit={handleSubmit} className='flex flex-col flex-1'>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6'>
        <div>
          ...
          <input
            ...
            className={`w-full p-4 border ${errors.firstName ? 'border-red-500' : 'border-slate-200'} rounded-lg text-base transition-all focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 bg-slate-50 focus:bg-white`}
        ...
        <div>
          ...
          <input
            ...
            value={data.lastName}
            onChange={handleChange}
            className={`w-full p-4 border ${errors.lastName ? 'border-red-500' : 'border-slate-200'} rounded-lg text-base transition-all focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 bg-slate-50 focus:bg-white`}
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          value={data.email}
          onChange={handleChange}
          className={`w-full p-4 border ${errors.email ? 'border-red-500' : 'border-slate-200'} rounded-lg text-base transition-all focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 bg-slate-50 focus:bg-white`}
      ...
      <div className='mb-6 relative'>
        ...
        <div className='relative'>
          <input
            ...
            value={data.password}
            onChange={handleChange}
            className={`w-full p-4 border ${errors.password ? 'border-red-500' : 'border-slate-200'} rounded-lg text-base transition-all focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 bg-slate-50 focus:bg-white`}
      ...
      <div className='mb-6'>
        ...
        <select
          ...
          required
        >
          <option value=''>Pilih Universitas/Institusi</option>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6'>
        <div>
          <label
            htmlFor='register-education-level'
            className='block font-semibold text-sm mb-1 text-slate-700'
          >
            Jenjang Pendidikan
          </label>
      ...
      <div className='mb-6'>
        <label
          ...
          className='block font-semibold text-sm mb-1 text-slate-700'
        >
          Nomor Induk Mahasiswa (Opsional)
        </label>
        <input
          type='text'
      ...
      <div className='mb-6'>
        <label className='block font-semibold text-sm mb-1 text-slate-700'>
          Daftar Sebagai
        </label>
      ...
      <button
        type='submit'
        disabled={processing}
        className={`w-full py-4 px-8 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold rounded-lg shadow-md transition-all relative overflow-hidden ${
          processing

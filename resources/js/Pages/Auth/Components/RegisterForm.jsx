  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col flex-1">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div>
          <label htmlFor="register-firstname" className="block font-semibold text-sm mb-1 text-slate-700">
            Nama Depan
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="register-lastname" className="block font-semibold text-sm mb-1 text-slate-700">
            Nama Belakang
          </label>
          <input
            type="text"
      ...
      <div className="mb-6">
        <label htmlFor="register-email" className="block font-semibold text-sm mb-1 text-slate-700">
          Email
        </label>
        <input
          type="email"
      ...
      <div className="mb-6 relative">
        <label htmlFor="register-password" className="block font-semibold text-sm mb-1 text-slate-700">
          Password
        </label>
      ...
      <div className="mb-6">
        <label htmlFor="register-university" className="block font-semibold text-sm mb-1 text-slate-700">
          Universitas
        </label>
        <input
          type="text"

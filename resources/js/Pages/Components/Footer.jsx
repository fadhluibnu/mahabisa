...
const Footer = () => {
  return (
    <footer className="bg-[#080a1a] text-white py-16">      <div className="max-w-7xl mx-auto px-4 md:px-5 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">          {/* Logo and Description */}
          <div className="col-span-1 md:col-span-6 lg:col-span-6">
            ...
            <p className="text-gray-400 mb-6 w-full md:w-3/4 lg:w-1/2 text-lg">
              Platform yang menghubungkan bakat mahasiswa dengan kesempatan profesional
            </p>
          ...
          {/* Links Container */}
          <div className="col-span-1 md:col-span-6 lg:col-span-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">              {/* For You */}
